...
class CommentController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      return back()->with('message','Your comment post successfully. After checking admin it will be published. Thank you for your comment.');
    }
    ...
    public function updaterstatus($id)
    {
