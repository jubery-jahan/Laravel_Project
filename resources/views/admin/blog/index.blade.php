            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary ">Add Blog Form </h6>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="card card-body">
                                                ...
                                                <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" value="" class="form-control" name="title" placeholder="Blog title"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea  class="summernote" name="description" placeholder="Blog Descrption" ></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="submit" class="btn btn-outline-success rounded-0 px-5" value="Create New Blog"/>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
