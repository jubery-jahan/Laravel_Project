...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}website/https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
                    ...
                    <div class="col-2 text-end">
                        ...
                        <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    <li><a href="{{route('my-dashboard')}}">My Dashbord</a></li>
